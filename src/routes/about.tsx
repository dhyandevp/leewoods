        ...
        <div className="site-container grid gap-14 lg:grid-cols-12 lg:gap-8">
          ...
          <div className="lg:col-span-7 lg:col-start-6">
            {principles.map(([number, title, copy]) => (
              <ScrollReveal
                key={title}
                className="grid gap-5 border-t border-border py-8 sm:grid-cols-[3rem_10rem_1fr]"
              >
      ...
      <section className="bg-foreground text-background">
        <div className="site-container grid gap-14 py-20 lg:grid-cols-12 lg:items-center lg:gap-8 lg:py-28">
          ...
          <ScrollReveal className="lg:col-span-4 lg:col-start-9">
            ...
            <p className="mt-8 text-[15px] leading-8 text-background/72">
            ...
            <div className="mt-9 flex gap-3 border-t border-background/16 pt-6 text-sm leading-6 text-background/76">
